...
public class ActionBar extends LinearLayout {
    ...
    private ActionBarItem mHeaderActionBarItem;
    ...
    public ActionBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        mHeaderActionBarItem=this.newActionBarItem(NormalActionBarItem.class)
        		.setContentDescription(R.string.gd_go_home)
        		.setDrawable(mHomeDrawable);
    ...
    public ActionBarItem addLeftItem( ActionBarItem item, int itemId){
    	if (mItems.size() >= mMaxItemsCount) {
            /*
             * An ActionBar must contain as few items as possible. So let's keep
             * a limit :)
        ...
        if (item != null) {
            ...
            final int size = (int) getResources().getDimension(R.dimen.gd_action_bar_height);
            addView(itemView, 0, new LayoutParams(size, LayoutParams.FILL_PARENT));
    ...
    public ActionBarItem SetHeaderItemDrawable(Drawable drawable){
    	mHeaderActionBarItem.setDrawable(drawable);
    	return mHeaderActionBarItem;
    }
    public ActionBarItem SetHeaderItemContentDescription(int contentDescriptionId){
    	mHeaderActionBarItem.setContentDescription(contentDescriptionId);
    	return mHeaderActionBarItem;
    }
    public ActionBarItem SetHeaderItemContentDescription(CharSequence contentDescription){
    	mHeaderActionBarItem.setContentDescription(contentDescription);
    	return mHeaderActionBarItem;
    }
    public ActionBarItem SetHeaderItemId(int itemId){
    	mHeaderActionBarItem.setItemId(itemId);
    	return mHeaderActionBarItem;
    }
