...
public class ImageCache {
     ...
     */
    public ImageCache(Context context, ImageCacheParams cacheParams, File diskCacheDir) {
        init(context, cacheParams, diskCacheDir);
    }
     ...
     *            directory
     */
    public ImageCache(Context context, String uniqueName, File diskCacheDir) {
        init(context, new ImageCacheParams(uniqueName), diskCacheDir);
    }
     ...
     */
    private void init(Context context, ImageCacheParams cacheParams, File diskCacheDir) {
    	// Set up disk cache
    ...
    public Bitmap getBitmapFromCache(String data){
        if (mMemoryCache != null) {
            Bitmap memBitmap = mMemoryCache.get(data);
            if (memBitmap != null) {
        ...
        if (mDiskCache != null) {
        	Bitmap value= mDiskCache.get(data);
        	if(value!=null)
